                                    ...
                                    <span wire:key="paginator-{{ $paginator->getPageName() }}-page{{ $page }}">
                                        @if ($page == $paginator->currentPage())
                                            <span aria-current="page">
                                                <span class="relative inline-flex items-center px-4 py-2 -ml-px text-sm font-bold text-white bg-gray-800 border border-gray-500 cursor-default leading-5 dark:bg-gray-100 dark:text-gray-900 dark:border-gray-400">{{ $page }}</span>
                                            </span>
                                        @else
