...
>
    <div class="mb-4 flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
        <div>
            ...
            <p class="text-xs text-slate-500">Define al cliente, la información base y el producto a desarrollar.</p>
        </div>
    ...
    <div class="grid grid-cols-1 gap-4 xl:grid-cols-2">
                    ...
                    <template x-for="user in ($wire.usuariosSugeridos || [])" :key="user.id">
                        ...
                        >
                            ...
                            <template x-if="user.id === {{ auth()->id() }}">
                                <span class="ml-2 shrink-0 text-xs text-blue-500">— Actual</span>
                            </template>
                        </div>
                    </template>
        ...
        <div>
            ...
            <input type="text" wire:model="nombre" class="mt-1 w-full rounded-xl border-slate-300 px-3 py-2 text-sm shadow-sm focus:border-blue-500 focus:ring-blue-500">
        ...
        <div>
            ...
            <select wire:change="onCategoriaChange" wire:model="categoria_id" class="mt-1 w-full rounded-xl border-slate-300 px-3 py-2 text-sm shadow-sm focus:border-blue-500 focus:ring-blue-500">
        ...
        <div class="xl:col-span-2">
            ...
            <textarea wire:model="descripcion" rows="3" class="mt-1 w-full rounded-xl border-slate-300 px-3 py-2 text-sm shadow-sm focus:border-blue-500 focus:ring-blue-500"></textarea>
        ...
        <div>
            ...
            <select wire:change="onProductoChange" wire:model="producto_id" class="mt-1 w-full rounded-xl border-slate-300 px-3 py-2 text-sm shadow-sm focus:border-blue-500 focus:ring-blue-500">
        ...
        <div class="space-y-3">
            ...
            @if ($mostrar_selector_armado)
                <div>
                    <label class="block text-sm font-medium text-slate-700">¿El proyecto será armado?</label>
                    <select wire:model="seleccion_armado" wire:change="despligaformopciones" class="mt-1 w-full rounded-xl border-slate-300 px-3 py-2 text-sm shadow-sm focus:border-blue-500 focus:ring-blue-500">
