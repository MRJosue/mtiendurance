<div class="mb-5 rounded-2xl border border-slate-200 bg-white p-4 shadow-sm">
    <div class="mb-4 flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
        <div>
            <label class="block text-sm font-semibold text-slate-800">Características y Opciones</label>
            <p class="text-xs text-slate-500">Selecciona las opciones necesarias para cada característica del producto.</p>
        </div>
