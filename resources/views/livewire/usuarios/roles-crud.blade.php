...
>
    ...
    @if($modalRol)
        <div class="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
            <div class="w-[95vw] max-w-lg max-h-[90vh] bg-white rounded-2xl shadow-xl flex flex-col">
                ...
                <div class="p-5 overflow-y-auto space-y-4">
                    ...
                    <div>
                        ...
                        @error('tipoRol') <span class="text-red-500 text-xs">{{ $message }}</span> @enderror
                    </div>
                </div>
                ...
                <div class="border-t p-5 flex justify-end gap-2">
                    ...
                    <button class="px-4 py-2 rounded bg-blue-600 hover:bg-blue-700 text-white" wire:click="guardarRol">
                        Guardar
                    </button>
                </div>
            </div>
