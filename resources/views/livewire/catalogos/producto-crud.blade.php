<div class="max-w-6xl mx-auto p-4">
    ...
    <div class="flex items-center justify-between mb-3 space-x-2">
        ...
        <div class="flex space-x-2">
            <input type="text" wire:model="query" placeholder="Buscar por nombre..."
    ...
    <table class="w-full border-collapse border border-gray-300">
        <thead>
            <tr class="bg-gray-100">
                ...
                <th class="border border-gray-300 p-2 text-left">Categorías</th>
            ...
            @foreach ($productos as $prod)
                <tr>
                    ...
                    <td class="border border-gray-300 p-2 flex space-x-2 justify-center">
                        <button wire:click="editar('{{ $prod->id }}')"
