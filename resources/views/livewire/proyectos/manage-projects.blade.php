<div x-data="{ selectedProjects: @entangle('selectedProjects') }">
                ...
                <tbody>
                    @foreach($projects as $project)
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="border-b px-4 py-2 text-gray-700 text-sm">    <a href="{{ route('proyecto.show', $project->id) }}" class="text-blue-500 hover:underline"> Ver detalles </a></td>
                        </tr>
                    @endforeach
                </tbody>
            </table>
