<div class="flex justify-center space-x-4 p-4 bg-white rounded-lg shadow-md">
    ...
    <button wire:click="cambiarEstado('rechazar')" 
        class="flex items-center px-4 py-2 bg-red-600 text-white rounded-lg hover:bg-red-700 disabled:opacity-50 disabled:cursor-not-allowed"
