...
<div x-data="{ uploading: false, progress: 0 }"
    ...
    <label class="block text-sm font-medium text-gray-700 dark:text-gray-200 mb-1">Archivo de diseño</label>
    <input
        type="file"
...
<textarea wire:model="comentario" placeholder="Comentario (opcional)" class="dashboard-input mb-3 mt-3 min-h-[96px] p-2"></textarea>
    ...
    @if($modalConfirmarMuestra)
        <div class="dashboard-modal-backdrop">
            <div class="dashboard-modal-panel max-w-md">
                ...
                {{-- Cantidad solicitada --}}
                <label class="mb-1 block font-medium text-gray-800 dark:text-gray-100">Cantidad solicitada</label>
                <input
                    type="number"
                    min="1"
                    max='10'
                    wire:model="cantidadMuestra"
                    class="dashboard-input mb-3 p-2"
                />
                ...
                {{-- Instrucciones --}}
                <label class="mb-1 block font-medium text-gray-800 dark:text-gray-100">Instrucciones</label>
                <textarea
                    wire:model="instruccionesMuestra"
                    class="dashboard-input mb-4 min-h-[96px] p-2"
                    rows="3"
    ...
    @if($modalAprobar)
        <div class="dashboard-modal-backdrop">
            <div class="dashboard-modal-panel max-w-md">
                ...
                <div class="flex justify-end space-x-2">
                    <button wire:click="$set('modalAprobar', false)" class="project-button-secondary">Cancelar</button>
                    <button wire:click="aprobarDiseno" class="rounded-md bg-green-500 px-4 py-2 text-white transition hover:bg-green-600">Confirmar</button>
                </div>
            </div>
        </div>
    @endif
    ...
    @if($modalAprobarPedido)
        <div class="dashboard-modal-backdrop">
            <div class="dashboard-modal-panel max-w-md">
                ...
                <div class="flex justify-end space-x-2">
                    <button wire:click="$set('modalAprobarPedido', false)" class="project-button-secondary">Cancelar</button>
                    <button wire:click="aprobarUltimoPedido" class="project-button-primary">Aprobar Pedido</button>
                </div>
            </div>
        </div>
    @endif
    ...
    @if($modalRechazar)
        <div class="dashboard-modal-backdrop">
            <div class="dashboard-modal-panel max-w-md">
                ...
                <textarea wire:model="comentarioRechazo" placeholder="Escribe el motivo del rechazo" class="dashboard-input mb-3 min-h-[96px] p-2"></textarea>
                @error('comentarioRechazo') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                <div class="flex justify-end space-x-2">
                    <button wire:click="$set('modalRechazar', false)" class="project-button-secondary">Cancelar</button>
                    <button wire:click="rechazarDiseno" class="rounded-md bg-red-500 px-4 py-2 text-white transition hover:bg-red-600">Rechazar</button>
                </div>
            </div>
        </div>
    @endif
        ...
        <div class="dashboard-modal-backdrop">
            <div class="dashboard-modal-panel max-w-md">
                ...
                <div x-data="{ uploading: false, progress: 0 }"
                    ...
                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-200 mb-1">Arte (1 archivo)</label>
                    <input
                        type="file"
                        class="dashboard-input px-3 py-2"
                        wire:model="archivo"
