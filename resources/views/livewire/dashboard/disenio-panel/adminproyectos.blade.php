<div>
            <div 
                        x-data="{
                            abierto: JSON.parse(localStorage.getItem('dashboard_adminproyectosdisenio_abierto') ?? 'true'),
                            toggle() {
                                this.abierto = !this.abierto;
                                localStorage.setItem('dashboard_adminproyectosdisenio_abierto', JSON.stringify(this.abierto));
                            }
                        }"
